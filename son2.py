...
\t|_______/[___]   \'-;__/[_____][_____]'.__.'[___]    	
			{m}•{k}•{h}•{sir} Author : Muhammad Amir {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('>> Mau Berapa Target Dek ? : '))
	except ValueError:
		print('>> Masukkan Angka Dek, Malah Huruff ')
		exit()
	if jum<1 or jum>100:
		print('>> Gagal Dump Id ')
		exit()
